...
//
Console.WriteLine("\nReading ENCYCLOPEDIA entities from db:");
var watch1 = Stopwatch.StartNew();
var encyclopedia = GetEncyclopediaFromDb(dbUsername, dbPassword);
watch1.Stop();
Console.WriteLine($"Downloaded ENCYCLOPEDIA entities to memory: {encyclopedia.Count}");
...
//
Console.WriteLine("\nWriting ENCYCLOPEDIA entities to HTML files:");
var watch2 = Stopwatch.StartNew();
FileCounts fc = WriteFiles(encyclopedia, directoryPath);
watch2.Stop();
...
private static void DisplayUsage()
{
    ...
    Console.WriteLine("Downloads all ENCYCLOPEDIA entries, from the db in Azure, to a directory.");
...
private List<EncyclopediaEntity> GetEncyclopediaFromDb(string dbUserName, string dbPassword)
{
...
private FileCounts WriteFiles(List<EncyclopediaEntity> entities, string path)
{
